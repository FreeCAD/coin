                               ...
                               const SoRenderParams & params)
{
  ...
  this->glue->glUniform1f(this->uMetalnessLocation, cmd.material.metalness);
  this->glue->glUniform1f(this->uRoughnessLocation, cmd.material.roughness);
                              ...
                              const SoRenderParams & params)
{
  ...
  this->glue->glUniform1f(this->uStipplePeriodLocation, 0.0f);
  this->glue->glUniform1f(this->uMetalnessLocation, 0.0f);
  this->glue->glUniform1f(this->uRoughnessLocation, 0.5f);
...
SoGLRenderBackend::createShaders()
{
  ...
  this->uMetalnessLocation = cc_glglue_glGetUniformLocation(this->glue, this->shaderProgram, "u_metalness");
  this->uRoughnessLocation = cc_glglue_glGetUniformLocation(this->glue, this->shaderProgram, "u_roughness");
