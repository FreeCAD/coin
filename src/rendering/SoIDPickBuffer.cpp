...
{
  // The context may already be gone. Do not attempt even best-effort GL
  // deletion here; all names become invalid with the context itself.
  this->glue = nullptr;
  this->fbo = 0;
  this->colorTex = 0;
  this->depthRbo = 0;
